<?php   
	...
	$customer_id = ((isset($_REQUEST["customer_id"]))?$customer_id = (int)$_REQUEST["customer_id"]:-1);
	$typ = 1;
	...
	$xgrid->whereClause[$gname] = " and `customer_id` = $customer_id ";
...
<div align="center">
	...
	<?php 
		...
		echo "<h2>ثبت وجه دریافتی از ".(($customer_id == -1)?"مشتریان":$customer->name)."</h2>";
		echo "<br/>"; ?>
</div>
