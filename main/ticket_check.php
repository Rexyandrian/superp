...
//---------Customer Problems---------------
		...
		$xgrid->column[$gname][1]['cfunction']=array('loadShomare');
		...
		$xgrid->column[$gname][4] = $gid;
		$xgrid->column[$gname][4]['name'] ='مسیر';
		$xgrid->column[$gname][4]['cfunction']=array('loadRoute');
		$xgrid->column[$gname][5]['name'] ='قیمت بلیت';
		...
		$xgrid->column[$gname][15]['name'] ='مبلغ تور';
		$xgrid->column[$gname][15]['cfunction']=array('monize');
		$xgrid->column[$gname][16] = $xgrid->column[$gname][0];
		$xgrid->column[$gname][16]['name'] ='کمیسیون';
		$xgrid->column[$gname][16]['cfunction']=array('poorsant');
