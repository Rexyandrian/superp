			...
			<div id="all_div" >
				...
				<div id="login_div" >
					<table id="login_tb" >
						...
						<tr>
							<td>
								<input name="user" id="uname" type="text" value="" class="textbox" onkeydown="onEnterpress(event);" >
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<input name="pass" id="pass" type="password" value="" class="textbox"  onkeydown="onEnterpress(event);" >
							</td>
						</tr>
						<tr>
							<td colspan="3">
