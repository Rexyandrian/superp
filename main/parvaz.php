<?php   include_once("../kernel.php");
	...
	$xgrid->column[$gname][17]['name'] ='قیمت روی بلیط';
	$xgrid->column[$gname][17]['cfunction'] = array('monize');
