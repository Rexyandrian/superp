<?php
	...
	{
		$su = sanadJam("`typ`=1 and `sanad_typ`=2 and (date(`tarikh`) >= '$aztarikh' and date(`tarikh`) <= '$tatarikh') ".(($customer_id>0)?" and `customer_id` = $customer_id ":''));
	...
	$xgrid->whereClause[$gname] = "`typ`=1 and `sanad_typ`=2 and (date(`tarikh`) >= '$aztarikh' and date(`tarikh`) <= '$tatarikh') ".(($customer_id>0)?" and `customer_id` = $customer_id ":'');
