...
<div align="center" style='width:21cm;height:29.5cm;'>
		...
		<tr>
			...
			تاریخ و محل صدور :	
					...
					<tr>
						<td colspan="3" style="height:0.6cm;">
...
‫فاقد اعتبار بعد از
		...
		<tr valign="top" style="height:0.6cm;">
			...
			<td>
				<p style="text-align: center;"><span ><b>20</b></span></p>
			</td>‬
			<td>
				...
				<table border="1">
					<tr>
						<td width="0.91cm" style="height:0.8cm;">
							<p style="text-align: center;"><span ><br/><br/><br/><br/>&nbsp;</span></p>
						</td>
						<td width="0.92cm">
							<p style="text-align: center;"><span ><b>OK</b></span></p>
						</td>
						<td width="1.41cm">
							<p style="text-align: center;"><span ><b><?php echo $parvaz->saat; ?></b>‬‫</span></p>
						</td>
						<td width="1.38cm">
							<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
								<tr>
									<td>
										<br/><br/><b><?php echo perToEnNums(jdate("m/d",strtotime($parvaz->tarikh))); ?></b>
									</td>
									<td style="border-right-style:solid;">
										<br/><br/><b><?php echo date("d M",strtotime($parvaz->tarikh)); ?></b><br/><br/><br/>
									</td>
								</tr>
							</table>
						</td>
						<td  width="1.38cm">
							<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
								<tr>
									...
									<td style="border-right-style:solid;">
										<br/><br/><b><?php echo $parvaz->shomare; ?></b><br/><br/><br/>
									</td>
								</tr>
							</table>
						</td>
						<td width="0.93cm" style="height:0.8cm;">
							<p style="text-align: center;"><span><br/><br/><b><?php echo loadSherkat($parvaz->sherkat_id); ?> </b></span></p>
						</td>
						<td width="4.6cm" >
							...
							<table style="text-align: center;width:100%;"  border="0">
								...
								<tr>
									...
									<td align="center" colspan="30">
										nbsp;&nbsp;<br/><b><?php echo ticket_class::rahgiriToCode($ticket->sanad_record_id,conf::rahgiri); ?></b>
									</td>
								</tr>
							</table>
						</td>
...
&nbsp;
		...
		PNR
				...
				<tr>
					<td colspan='2' style="font-size: 12px;" >
					<b><?php echo ticket_class::rahgiriToCode($ticket->sanad_record_id,conf::rahgiri); ?></b>					
					</td>
				</tr>
			</table>
		</td>
...
-->
		...
		<table style="font-family:b zar,zar,tahoma;font-size:14px;direction:rtl;">
			<tr>
				<td>
		<p align="right" style="font-family:b zar,zar,tahoma;font-size:14px;direction:rtl;">
...
<br/>
					* حمل و نقل مزبور مشمول مقررات مربوط به مسئولیت مقرر در کنوانسیون ورشو ۱۹۲۹ می‌باشد. جهت کسب اطلاعات بیشتر به http://www.radan24.com مراجعه کنید.
		</p>
				</td>
			</tr>
...
&nbsp;
		...
		<tr style="height:0.8cm;" >
			<td style="text-align: center;" colspan="8" rowspan="3">
				<?php
					$b = new barcode_class(ticket_class::rahgiriToCode($ticket->sanad_record_id,conf::rahgiri));
					echo '<img src="../img/barcodes/'.ticket_class::rahgiriToCode($ticket->sanad_record_id,conf::rahgiri).'.png" alt="'.ticket_class::rahgiriToCode($ticket->sanad_record_id,conf::rahgiri).'" />';
				?>
			</td>
			<td colspan="4">
				<table style="text-align: center;font-size: 6px;width:100%;height:100%;" >
