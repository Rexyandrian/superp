<?php 
	...
	if(isset($_REQUEST['trans_id']) && isset($_REQUEST['id_get']))
	{
		...
		if((int)$result>0 && $pardakht->id>0)
		{
			...
			$out = '
در تراکنش مالی مشکلی پیش آمده است پرداخت انجام نشد مجدد سعی نمایید درصورت کسر وجه حتما با پشتیبانی سایت تماس بگیرید<br/><br/>
09121076556 
			<br/><br/><br/>
			<input class="inp" type="button" value="بازگشت به صفحه پروازها" onclick="window.location=\'index.php\';" />';
	}
	else
		$out = 'در تراکنش مالی مشکلی پیش آمده است پرداخت انجام نشد مجدد سعی نمایید درصورت کسر وجه حتما با پشتیبانی سایت تماس بگیرید<br/><br/>
09121076556  
			<br/>
			<input class="inp" type="button" value="بازگشت به صفحه پروازها" onclick="window.location=\'index.php\';" />';
?>
